...
const HappyCustomers = () => {
  ...
  useEffect(() => {
    setDisplayedCustomers(
      initialCustomers.slice(currentIndex, currentIndex + 3)
    );
  }, [currentIndex]);
  ...
  return (
    <div className="px-4 py-8 flex items-center justify-center sm:px-8 lg:px-16 xl:px-24">
      <div className="max-w-screen-lg mx-auto">
        <h1 className="font-integral font-bold text-4xl text-center mb-8">
          OUR HAPPY CUSTOMERS
        </h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          {displayedCustomers.map((customer, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-between p-4 w-full md:w-[300px] border-2"
            >
